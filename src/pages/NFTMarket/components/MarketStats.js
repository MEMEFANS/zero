...
const StatCard = ({ title, value, unit = '' }) => (
  <div className="bg-[#1A2333] rounded-xl p-4 sm:p-6 backdrop-blur-lg border border-[#2D3748] hover:border-green-500/30 transition-all duration-300 h-full flex flex-col items-center">
